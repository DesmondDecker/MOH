...
const NAV_ITEMS = [
  { to: '/clinical', label: "Today's queue", end: true },
  { to: '/clinical/search', label: 'Find patient' },
  { to: '/clinical/register', label: 'Register patient' },
  { to: '/clinical/blood-bank', label: 'Blood bank' },
];
    ...
    <div className="min-h-screen flex bg-canvas">
      <aside className="w-56 shrink-0 border-r border-border bg-canvas-raised flex flex-col">
        <div className="px-4 py-5 border-b border-border">
          ...
          <p className="font-display text-lg text-ink leading-tight mt-0.5">Clinical</p>
        </div>
